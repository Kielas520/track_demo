...
def main():
    ...
    cv2.createTrackbar('Q_z', main_window_name, 100, 1000, nothing)
    cv2.createTrackbar('Q_vx', main_window_name, 320, 1000, nothing)
    cv2.createTrackbar('Q_vy', main_window_name, 320, 1000, nothing)
    cv2.createTrackbar('Q_vz', main_window_name, 20, 1000, nothing)
    cv2.createTrackbar('R_x', main_window_name, 200, 1000, nothing)
    cv2.createTrackbar('R_y', main_window_name, 200, 1000, nothing)
    cv2.createTrackbar('R_z', main_window_name, 800, 1000, nothing)
